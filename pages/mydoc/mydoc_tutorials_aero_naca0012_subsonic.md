...
permalink: tutorials-aero-naca0012-subsonic.html
folder: mydoc
---
...
The "runScript.py" is similar to the one used in the NACA0012 [low speed case](get-started-runscript.html) with the following exceptions:
