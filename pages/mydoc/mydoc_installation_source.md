...
The supported repo versions in the MACH-Aero framework for DAFoam-v2.0.0 is as follows

baseclasses | pySpline | pyGeo  | multipoint | pyHyp  | cgnsUtilities | IDWarp  | pyOptSparse | pyOFM  | DAFoam
| :----------------------------------------------------------------------------------------------------------- | 
v1.2.0      | v1.2.0   | v1.2.0 | v1.2.0     | v2.2.0 | v2.2.0        | v2.2.0  | v2.1.3      | v1.2.0 | v2.0.0
...
tar -xvf dafoam.tar.gz && cd dafoam-2.0.0 && \
. $HOME/OpenFOAM/OpenFOAM-v1812/etc/bashrc && \
./Allmake && pip install .
</pre>
