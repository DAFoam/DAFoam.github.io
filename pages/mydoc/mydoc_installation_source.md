...
echo 'export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$DAFOAM_ROOT_PATH/OpenFOAM/sharedLibs' >> $HOME/dafoam/loadDAFoam.sh && \
. $HOME/dafoam/loadDAFoam.sh && \
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$DAFOAM_ROOT_PATH/OpenFOAM/sharedLibs
</pre>
...
This step is only needed if you want to use the automatic differentiation feature (adjJacobianOption=JacobianFree) in DAFoam. Skip this step will NOT impact DAFoam's optimization capability, but you have to use the default finite-difference Jacobian adjoint, i.e., adjJacobianOption=JacobianFree. Check the detail of the adjJacobianOption key on [this page](https://dafoam.github.io/doxygen/html/classdafoam_1_1pyDAFoam_1_1DAOPTION.html).
