...
- Run CFD simulations. You can ask Claude: "Run a CFD simulation with aoa=3, Ma=0.3, Re=1e6". Claude will run the CFD simulation in the background. 
...
- View flow field. You can say "View the velocity field" to see velocity profile. You can also ask Claude to "Zoom in to the trailing edge". Click the provided link to see the contours in your browser.
